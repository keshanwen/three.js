...
// 道路宽度
var W = 10;
var geometry = new THREE.PlaneGeometry(500, W); //矩形平面
// 浏览器控制台查看几何体UV坐标
...
var texture = texLoa.load('http://localhost:1234/finv/路面流光.png');
...
var texture2 = texLoa.load('http://localhost:1234/finv/路面流光.png');
// 设置阵列模式为 RepeatWrapping
